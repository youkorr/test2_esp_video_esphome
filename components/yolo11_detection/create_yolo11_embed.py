#!/usr/bin/env python3
"""Create embedded C file for YOLO11 model"""
...
def create_embed_c(espdl_file, c_file, symbol_name):
    ...
    c_content = f'''// Auto-generated - embedded YOLO11 detection model
#include <stddef.h>
#include <stdint.h>
...
if __name__ == "__main__":
    ...
    # Path to YOLO11 model
    yolo11_model = os.path.join(parent_dir, "yolo11_detect", "models", "p4", "yolo11_detect_s8_v1.espdl")

    # Create embedded file in yolo11_detection component
    create_embed_c(
        yolo11_model,
        os.path.join(script_dir, "yolo11_detect_espdl_embed.c"),
        "_binary_yolo11_detect_espdl_start"
    )

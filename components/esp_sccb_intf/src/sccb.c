...
esp_err_t esp_sccb_transmit_reg_a8v8(esp_sccb_io_handle_t io_handle, uint8_t reg_addr, uint8_t reg_val)
{
    ...
    ESP_RETURN_ON_FALSE(io_handle->transmit_reg_a8v8, ESP_ERR_NOT_SUPPORTED, TAG,
                        "controller driver function not supported");
...
{
    ESP_RETURN_ON_FALSE(io_handle, ESP_ERR_INVALID_ARG, TAG, "invalid argument: null pointer");
    ESP_RETURN_ON_FALSE(io_handle->transmit_reg_a16v8, ESP_ERR_NOT_SUPPORTED, TAG,
                        "controller driver function not supported");
...
esp_err_t esp_sccb_transmit_reg_a8v16(esp_sccb_io_handle_t io_handle, uint8_t reg_addr, uint16_t reg_val)
{
    ...
    ESP_RETURN_ON_FALSE(io_handle, ESP_ERR_INVALID_ARG, TAG, "invalid argument: null pointer");
    ESP_RETURN_ON_FALSE(io_handle->transmit_reg_a8v16, ESP_ERR_NOT_SUPPORTED, TAG,
                        "controller driver function not supported");
    ...
    ESP_RETURN_ON_ERROR(io_handle->transmit_reg_a8v16(io_handle, data, 4, ESP_SCCB_TRANS_DEALY), TAG,
                        "failed to transmit_reg_a8v16");
...
esp_err_t esp_sccb_transmit_reg_a16v16(esp_sccb_io_handle_t io_handle, uint16_t reg_addr, uint16_t reg_val)
{
    esp_err_t ret = ESP_FAIL;
    ESP_RETURN_ON_FALSE(io_handle, ESP_ERR_INVALID_ARG, TAG, "invalid argument: null pointer");
    ESP_RETURN_ON_FALSE(io_handle->transmit_reg_a16v16, ESP_ERR_NOT_SUPPORTED, TAG,
                        "controller driver function not supported");
    ...
    ESP_RETURN_ON_ERROR(io_handle->transmit_reg_a16v16(io_handle, data, 4, ESP_SCCB_TRANS_DEALY), TAG,
                        "failed to transmit_reg_a16v16");
    reg_val = __builtin_bswap16(reg_val);
    return ret;
}
...
{
    ESP_RETURN_ON_FALSE(io_handle, ESP_ERR_INVALID_ARG, TAG, "invalid argument: null pointer");
    ESP_RETURN_ON_FALSE(io_handle->transmit_receive_reg_a8v8, ESP_ERR_NOT_SUPPORTED, TAG,
                        "controller driver function not supported");
...
{
    ESP_RETURN_ON_FALSE(io_handle, ESP_ERR_INVALID_ARG, TAG, "invalid argument: null pointer");
    ESP_RETURN_ON_FALSE(io_handle->transmit_receive_reg_a16v8, ESP_ERR_NOT_SUPPORTED, TAG,
                        "controller driver function not supported");
    ESP_RETURN_ON_FALSE(reg_val, ESP_ERR_INVALID_ARG, TAG, "invalid argument: reg_val null pointer");
...
esp_err_t esp_sccb_transmit_receive_reg_a8v16(esp_sccb_io_handle_t io_handle, uint8_t reg_addr, uint16_t *reg_val)
{
    esp_err_t ret = ESP_FAIL;
    ESP_RETURN_ON_FALSE(io_handle, ESP_ERR_INVALID_ARG, TAG, "invalid argument: null pointer");
    ESP_RETURN_ON_FALSE(io_handle->transmit_receive_reg_a8v16, ESP_ERR_NOT_SUPPORTED, TAG,
                        "controller driver function not supported");
    ESP_RETURN_ON_FALSE(reg_val, ESP_ERR_INVALID_ARG, TAG, "invalid argument: reg_val null pointer");
    ...
    ESP_RETURN_ON_ERROR(
        io_handle->transmit_receive_reg_a8v16(io_handle, data, 1, (void *)reg_val, 2, ESP_SCCB_TRANS_DEALY), TAG,
        "failed to transmit_receive_reg_a8v16");
    *reg_val = __builtin_bswap16(*reg_val);
    return ret;
}
...
esp_err_t esp_sccb_transmit_receive_reg_a16v16(esp_sccb_io_handle_t io_handle, uint16_t reg_addr, uint16_t *reg_val)
{
    esp_err_t ret = ESP_FAIL;
    ESP_RETURN_ON_FALSE(io_handle, ESP_ERR_INVALID_ARG, TAG, "invalid argument: null pointer");
    ESP_RETURN_ON_FALSE(io_handle->transmit_receive_reg_a16v16, ESP_ERR_NOT_SUPPORTED, TAG,
                        "controller driver function not supported");
    ESP_RETURN_ON_FALSE(reg_val, ESP_ERR_INVALID_ARG, TAG, "invalid argument: reg_val null pointer");
    ...
    ESP_RETURN_ON_ERROR(
        io_handle->transmit_receive_reg_a16v16(io_handle, data, 2, (void *)reg_val, 2, ESP_SCCB_TRANS_DEALY), TAG,
        "failed to transmit_receive_reg_a16v16");
    *reg_val = __builtin_bswap16(*reg_val);
    return ret;
}

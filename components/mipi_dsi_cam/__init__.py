...
CONFIG_SCHEMA = cv.Schema({
    ...
    cv.Optional(CONF_PIXEL_FORMAT, default="RGB565"): cv.string,  # SC202CS capture en RGB565
    ...
    cv.Optional(CONF_AUTO_START, default=False): cv.boolean,  # lvgl_camera_display gère le start/stop

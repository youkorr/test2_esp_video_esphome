...
void ESPVideoComponent::setup() {
  ...
  // Note: L'initialisation réelle d'ESP-Video est effectuée par les 
  // composants qui l'utilisent (ex: mipi_dsi_cam), car elle nécessite
  // des paramètres spécifiques au capteur et à la configuration.

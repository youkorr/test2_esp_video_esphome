...
// unencrypted models. The face_detection component ships the same stub with
// strong symbols. This copy uses __attribute__((weak)) so it only wins when
// no other component provides the real implementation.

...
/* --------------------------------------------------------------------------
 *  Mode 1280x720 @ 30fps (MODE M5Stack Tab5 standard)
 * --------------------------------------------------------------------------*/

static const sc202cs_reginfo_t init_reglist_custom_MIPI_1lane_raw8_1280x720_30fps[] = {
    {0x0103, 0x01},          {SC202CS_REG_SLEEP_MODE, 0x00},
    {0x36e9, 0x80},          {0x36ea, 0x06},
    {0x36eb, 0x0a},          {0x36ec, 0x01},
    {0x36ed, 0x18},          {0x36e9, 0x24},
    ...
    {0x320b, 0xd0},
    /* Frame timing - CRITICAL for 1280x720 @ 30fps! */
    {0x320c, 0x07},          {0x320d, 0x80},  /* HTS = 1920 */
    {0x320e, 0x04},          {0x320f, 0xe2},  /* VTS = 1250 */
    {0x3210, 0x00},
...
/* ISP info for 1280x720 mode - Match M5Stack Tab5 values */
static const esp_cam_sensor_isp_info_t sc202cs_1280x720_isp_info = {
    .isp_v1_info = {
        .version = SENSOR_ISP_INFO_VERSION_DEFAULT,
        .pclk = 72000000,     /* Pixel clock */
        .hts = 1920,          /* Horizontal Total Size */
...
/* --------------------------------------------------------------------------
 *  Descripteur de format esp_video pour le mode 1280x720
 * --------------------------------------------------------------------------*/

static const esp_cam_sensor_format_t sc202cs_custom_format_1280x720 = {
    ...
    .width     = 1280,
    .height    = 720,
    .regs      = init_reglist_custom_MIPI_1lane_raw8_1280x720_30fps,
    .regs_size = ARRAY_SIZE(init_reglist_custom_MIPI_1lane_raw8_1280x720_30fps),
    .fps       = 30,
    .isp_info  = &sc202cs_1280x720_isp_info,
    .mipi_info = {
        .mipi_clk     = 576000000,  /* 576 Mbps, 1 lane */
        .lane_num     = 1,
        .line_sync_en = false,

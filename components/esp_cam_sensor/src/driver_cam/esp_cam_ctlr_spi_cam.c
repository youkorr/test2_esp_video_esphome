...
// Provide default values for ESPHome builds where Kconfig may not be available
#ifndef CONFIG_CAM_CTLR_SPI_DECODE_TASK_STACK_SIZE
#define CONFIG_CAM_CTLR_SPI_DECODE_TASK_STACK_SIZE 4096
#endif
#ifndef CONFIG_CAM_CTLR_SPI_DECODE_TASK_PRIORITY
#define CONFIG_CAM_CTLR_SPI_DECODE_TASK_PRIORITY 5
#endif

...
//   - 640x360 @ 30fps RAW10 (nHD 16:9) - full sensor (0-1935 x 4-1091), ISP downscales, 0% crop, 8-byte aligned (rotation safe!)
...
// Custom format 640x360 @ 30fps RAW10 (nHD 16:9 - Perfect FOV, rotation safe!)
extern const esp_cam_sensor_format_t ov02c10_format_640x360_raw10_30fps;

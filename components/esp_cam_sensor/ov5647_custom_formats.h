...
// 800x640 clock rates removed - resolution caused stride issues, use 800x600 instead
...
// ============================================================================
// Configuration 4 : 800x640 REMOVED - caused stride/alignment issues
// ============================================================================
// 800x640 is a non-standard resolution that causes stride artifacts.
// Use 800x600 (SVGA) instead, which is a standard 4:3 resolution.
// If 800x640 is requested at runtime, it is automatically redirected to 800x600.

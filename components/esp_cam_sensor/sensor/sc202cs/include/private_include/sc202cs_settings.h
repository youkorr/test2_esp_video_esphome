...
static const sc202cs_reginfo_t init_reglist_MIPI_1lane_raw10_1600x1200_30fps[] = {
    ...
    {0x301f, 0x01},
    /* Frame timing registers for 30fps (MUST be before analog settings!) */
    {0x320c, 0x07},          {0x320d, 0x80},  /* HTS = 1920 (0x0780) */
    {0x320e, 0x04},          {0x320f, 0xe2},  /* VTS = 1250 (0x04E2) */
    {0x3301, 0xff},
...
static const sc202cs_reginfo_t init_reglist_MIPI_1lane_raw10_1600x900_30fps[] = {
    ...
    {0x3202, 0x00}, {0x3203, 0x96},
    {0x3204, 0x06}, {0x3205, 0x47},
    {0x3206, 0x04}, {0x3207, 0x21},
    {0x3208, 0x06}, {0x3209, 0x40},
    {0x320a, 0x03}, {0x320b, 0x84},
    /* Frame timing registers for 30fps (MUST be here!) */
...
// Native 800x600 @ 30fps using centered crop
// SC202CS does NOT support hardware binning - this is a centered CROP
// HTS/VTS timing registers are CRITICAL for proper FPS!
static const sc202cs_reginfo_t init_reglist_MIPI_1lane_raw8_800x600_30fps[] = {
    ...
    /* Frame timing registers for 30fps (CRITICAL!) */
    {0x320c, 0x07},          {0x320d, 0x80},  /* HTS = 1920 (0x0780) */
    {0x320e, 0x04},          {0x320f, 0xe2},  /* VTS = 1250 (0x04E2) */
...
static const sc202cs_reginfo_t init_reglist_MIPI_1lane_raw8_1280x720_30fps[] = {
    ...
    {0x320b, 0xd0},
    /* Frame timing registers for 30fps (MUST be here with 0x32xx registers!) */
    {0x320c, 0x07},          {0x320d, 0x80},  /* HTS = 1920 (0x0780) */
    {0x320e, 0x04},          {0x320f, 0xe2},  /* VTS = 1250 (0x04E2) */
    {0x3210, 0x00},

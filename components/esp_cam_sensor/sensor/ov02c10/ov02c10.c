...
// Supported formats: 640x480 (VGA 4:3), 800x600 (SVGA 4:3), 1288x728 (16:9), 640x368 (near 16:9), 480x640 (portrait), 1920x1080 (1080P)
// All formats use full sensor with ISP downscaling

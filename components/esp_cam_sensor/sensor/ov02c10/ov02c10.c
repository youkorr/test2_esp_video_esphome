...
// Supported formats: 640x480 (VGA 4:3), 800x600 (SVGA 4:3), 854x480 (WVGA 16:9), 480x640 (portrait), 1920x1080 (1080P)
// All formats use full sensor with ISP downscaling, preserving maximum FOV
...
const esp_cam_sensor_format_t ov02c10_format_854x480_raw10_30fps = {
    .name = "MIPI_1lane_24Minput_RAW10_854x480_30fps",
    .format = ESP_CAM_SENSOR_PIXFORMAT_RAW10,
    .port = ESP_CAM_SENSOR_MIPI_CSI,
    .xclk = 24000000,
    .width = 854,
    .height = 480,
    .regs = ov02c10_input_24M_MIPI_1lane_raw10_854x480_30fps,
    .regs_size = ARRAY_SIZE(ov02c10_input_24M_MIPI_1lane_raw10_854x480_30fps),
    .fps = 30,
    .isp_info = &ov02c10_isp_info[0],
    .mipi_info = {
        .mipi_clk = OV02C10_MIPI_CSI_LINE_RATE_800x640_50FPS,

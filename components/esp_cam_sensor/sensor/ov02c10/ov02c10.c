...
// Supported formats: 640x480 (VGA), 800x600 (SVGA), 480x640 (VGA rotated), 1920x1080 (1080P)
// VGA/SVGA use full sensor with ISP downscaling, 1080P is native resolution

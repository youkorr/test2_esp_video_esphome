...
// ============================================================================
// VGA resolution with centered crop from OV02C10's active area
// Based on native 1288x728 @ 30fps configuration with adjusted crop window
 
static const ov02c10_reginfo_t ov02c10_input_24M_MIPI_1lane_raw10_640x480_30fps[] = {
    // PLL and clock configuration (same as native 1288x728)
    {0x0301, 0x08},
    {0x0303, 0x06},
    {0x0304, 0x01},
    {0x0305, 0x77},
    ...
    {0x37e5, 0x02},
    {0x37e6, 0x08},
    // Crop window: CENTERED for 640x480
    // Native crop: 320-1615 (X), 180-911 (Y) = 1295x731
    // For 640x480: Center X=(1295-640)/2+320=647, Center Y=(731-480)/2+180=305
    {0x3800, 0x02},  // X start high = 647
    {0x3801, 0x87},  // X start low
    {0x3802, 0x01},  // Y start high = 305
    {0x3803, 0x31},  // Y start low
    {0x3804, 0x05},  // X end high = 647+640-1=1286
    {0x3805, 0x06},  // X end low
    {0x3806, 0x03},  // Y end high = 305+480-1=784
    {0x3807, 0x10},  // Y end low
    // Output size: 640x480
    {0x3808, 0x02},  // width high = 640
    {0x3809, 0x80},  // width low
    {0x380a, 0x01},  // height high = 480
    {0x380b, 0xe0},  // height low
    // HTS and VTS - same as native for consistent timing
...
// ============================================================================
// SVGA resolution with centered crop from OV02C10's active area
// Based on native 1288x728 @ 30fps configuration with adjusted crop window
...
static const ov02c10_reginfo_t ov02c10_input_24M_MIPI_1lane_raw10_800x600_30fps[] = {
    ...
    {0x37e5, 0x02},
    {0x37e6, 0x08},
    // Crop window: CENTERED for 800x600
    // Native crop: 320-1615 (X), 180-911 (Y) = 1295x731
    // For 800x600: Center X=(1295-800)/2+320=567, Center Y=(731-600)/2+180=245
    {0x3800, 0x02},  // X start high = 567
    {0x3801, 0x37},  // X start low
    {0x3802, 0x00},  // Y start high = 245
    {0x3803, 0xf5},  // Y start low
    {0x3804, 0x05},  // X end high = 567+800-1=1366
    {0x3805, 0x56},  // X end low
    {0x3806, 0x03},  // Y end high = 245+600-1=844
    {0x3807, 0x4c},  // Y end low
    // Output size: 800x600
    {0x3808, 0x03},  // width high = 800
    {0x3809, 0x20},  // width low
    {0x380a, 0x02},  // height high = 600
    {0x380b, 0x58},  // height low
    // HTS and VTS - same as native for consistent timing
    {0x380c, 0x08},  // HTS high = 2280
    {0x380d, 0xe8},  // HTS low
    {0x380e, 0x04},  // VTS high = 1164

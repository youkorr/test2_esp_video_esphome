...
static const ov02c10_reginfo_t ov02c10_input_24M_MIPI_1lane_raw10_1280x800_30fps[] = {
    ...
    {0x3806, 0x03},
    {0x3807, 0x2f},
    {0x3808, 0x05},  // width high = 0x05
    {0x3809, 0x00},  // width low = 0x00 (1280 = 0x0500)
    {0x380a, 0x03},  // height high = 0x03
    {0x380b, 0x20},  // height low = 0x20 (800 = 0x0320)
    {0x380c, 0x08},
    {0x380d, 0xe8},
    {0x380e, 0x04},
    {0x380f, 0x8c},
...
static const ov02c10_reginfo_t ov02c10_input_24M_MIPI_1lane_raw10_640x480_30fps[] = {
    ...
    {0x3806, 0x02},
    {0x3807, 0x67},
    {0x3808, 0x02},  // width high = 0x02
    {0x3809, 0x80},  // width low = 0x80 (640 = 0x0280)
    {0x380a, 0x01},  // height high = 0x01
    {0x380b, 0xe0},  // height low = 0xe0 (480 = 0x01e0)
    {0x380c, 0x08},
    {0x380d, 0xe8},
    {0x380e, 0x04},
    {0x380f, 0x8c},
...
static const ov02c10_reginfo_t ov02c10_input_24M_MIPI_1lane_raw10_800x480_30fps[] = {
    {0x0301, 0x08},
    {0x0303, 0x06},
    {0x0304, 0x01},
    {0x0305, 0x77},
    ...
    {0x3806, 0x02},
    {0x3807, 0x23},
    {0x3808, 0x03},  // width high = 0x03
    {0x3809, 0x20},  // width low = 0x20 (800 = 0x0320)
    {0x380a, 0x01},  // height high = 0x01
    {0x380b, 0xe0},  // height low = 0xe0 (480 = 0x01e0)
    {0x380c, 0x08},
    {0x380d, 0xe8},
...
static const ov02c10_reginfo_t ov02c10_input_24M_MIPI_1lane_raw10_800x600_30fps[] = {
    ...
    {0x3808, 0x03},  // width high = 0x03
    {0x3809, 0x20},  // width low = 0x20 (800 = 0x0320)
    {0x380a, 0x02},  // height high = 0x02
    {0x380b, 0x58},  // height low = 0x58 (600 = 0x0258)
    {0x380c, 0x08},
    {0x380d, 0xe8},
    {0x380e, 0x04},
    {0x380f, 0x8c},

...
// ============================================================================
// Custom format: 960x540 @ 30fps RAW10 (qHD 16:9)
// ============================================================================
// qHD resolution (960x540) - Perfect balance between quality and FPS
// Strategy: Use full sensor crop (0-1935 x 4-1091), ISP downscales to 960x540
// This format is 16:9 (matching sensor), BETTER FPS than 1288x728
// After rotation 270°: 540x960 → PPA downscale to 480x390 (NO UPSCALE!)
// RAM: ~1 MB (vs 1.8 MB for 1288x728) - Excellent for face recognition with rotation

static const ov02c10_reginfo_t ov02c10_input_24M_MIPI_1lane_raw10_960x540_30fps[] = {
     {0x0301, 0x08},
     {0x0303, 0x06},
     {0x0304, 0x01},
     {0x0305, 0x77},
     ...
     {0x37e6, 0x08},
     {0x3800, 0x01},
     {0x3801, 0xe5},  // X start = 485
     {0x3802, 0x01},
     {0x3803, 0x14},  // Y start = 276
     {0x3804, 0x05},
     {0x3805, 0xaa},  // X end = 1450 (966 pixels crop)
     {0x3806, 0x03},
     {0x3807, 0x32},  // Y end = 818 (543 pixels crop)
     {0x3808, 0x03},  // width high
     {0x3809, 0xc0},  // width low = 960 (0x3C0)
     {0x380a, 0x02},  // height high
     {0x380b, 0x1c},  // height low = 540 (0x21C)
     {0x380c, 0x08},
     {0x380d, 0xe8},
     {0x380e, 0x04},
     {0x380f, 0x8c},

// Self-contained copy of yolo11_detect.hpp so the yolov11 component
// doesn't have to reach into a sibling external_components directory
// that ESPHome wouldn't otherwise sync into src/.
#pragma once
